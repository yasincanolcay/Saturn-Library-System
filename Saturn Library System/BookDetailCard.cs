...
{
    public partial class BookDetailCard : Form
    {
        ...
        public string[] Tag1 { get => tag1; set => tag1 = value; }
        ...
        private void numberLabel_MouseUp(object sender, MouseEventArgs e)
        {
            stockNumberShow();
        }
